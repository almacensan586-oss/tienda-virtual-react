...
export default function Admin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Validar Duplicados por Código (Solo si se está creando un producto nuevo)
            if (!isEditing) {
            ...
            if (isEditing) {
                ...
                setSearchParams({}); // Limpia el query param de la URL
            } else {
            ...
            // Vaciar los campos del formulario tras guardar con éxito
            setFormData(ESTADO_INICIAL);
        } catch (error) {
    ...
    // Acciones directas sobre la tabla
        ...
        <div className="container my-5 pb-5">
            ...
            <div className="row justify-content-center">
                <div className="col-lg-10">
                    ...
                    {/* SECCIÓN 3: HISTORIAL DE LOS 10 ÚLTIMOS PRODUCTOS */}
                                ...
                                <table className="table table-hover table-striped mb-0 align-middle">
                                    ...
                                    <tbody>
                                        {ultimosProductos.length === 0 ? (
                                            <tr>
                                                <td colSpan="6" className="text-center py-4 text-muted">No hay productos guardados en la base de datos.</td>
                                            </tr>
                                        ) : (
